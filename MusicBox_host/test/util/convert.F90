!> \file
!> Tests for the music_box_convert module

!> Test module for the music_box_convert module
program test_util_convert

  use music_box_assert
  use music_box_convert
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  subroutine test_convert_t( )
    ...
    use music_box_constants,           only : PI, AVAGADRO

    type(convert_t) :: a
    real(kind=kind_phys) :: ra, rb, rc, lon, cell_height
