...
module music_box_convert
  ...
  type :: convert_t
    ...
    !> Scaling factor
    real(kind=kind_phys) :: scale_factor_ = 1.0d0
    !> Offset
    real(kind=kind_phys) :: offset_ = 0.0d0
  contains
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  function constructor_char( standard_units, non_standard_units )             &
    ...
    use music_box_string,              only : string_t
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  function constructor( standard_units, non_standard_units ) result( new_obj )
    ...
    use music_box_assert,              only : die_msg
    use music_box_string,              only : string_t
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  function to_standard( this, non_standard_value, longitude__rad,             &
    ...
    !> Converted value
    real(kind=kind_phys) :: standard_value
    !> Converter
    class(convert_t), intent(in) :: this
    !> Non-standard value to convert
    real(kind=kind_phys), intent(in) :: non_standard_value
    !> Longitude [radians]
    real(kind=kind_phys), intent(in), optional :: longitude__rad
    !> Surface area [m2]
    real(kind=kind_phys), intent(in), optional :: cell_height__m
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  function to_non_standard( this, standard_value, longitude__rad,             &
    ...
    !> Converted value
    real(kind=kind_phys) :: non_standard_value
    !> Converter
    class(convert_t), intent(in) :: this
    !> Standard value to convert
    real(kind=kind_phys), intent(in) :: standard_value
    !> Longitude [radians]
    real(kind=kind_phys), intent(in), optional :: longitude__rad
    !> Surface area [m2]
    real(kind=kind_phys), intent(in), optional :: cell_height__m
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  subroutine set_up_for_UTC( this, non_standard )
    ...
    use music_box_assert,              only : die_msg
    use music_box_constants,           only : PI
    use music_box_string,              only : string_t
    ...
    real(kind=kind_phys) :: utc_offset
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  subroutine set_up_for_mol_per_m3( this, non_standard )
    ...
    use music_box_assert,              only : die_msg
    use music_box_constants,           only : AVAGADRO
    use music_box_string,              only : string_t
    ...
    real(kind=kind_phys) :: num_scale, space_scale
    logical :: use_slash
